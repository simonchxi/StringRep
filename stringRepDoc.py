...
inDoc = Document ('2021 10 October-Original test file.doc')
outDoc = Document ('2021 10 October-Translate file.doc')
...
replace(r'2021 10 October-Original test file.txt', 'Oct testout.txt','ATTACHED', '公寓')
